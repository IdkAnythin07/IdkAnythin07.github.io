import { i as __toESM, r as __require } from "./rolldown-runtime-B4lejLz5.js";
//#region node_modules/pyodide/pyodide.mjs
var Q = Object.defineProperty;
var o = (e, t) => Q(e, "name", {
	value: t,
	configurable: !0
}), R = ((e) => typeof __require < "u" ? __require : typeof Proxy < "u" ? new Proxy(e, { get: (t, n) => (typeof __require < "u" ? __require : t)[n] }) : e)(function(e) {
...
var N = [
	...
	"isNative",
	"isToplevel"
], I = ["columnNumber", "lineNumber"], S = [
	"fileName",
	"functionName",
	"source"
], F = N.concat(I, S, ["args"], ["evalOrigin"]);
function p(e) {
...
var $, x, B, L;
async function C() {
	if (!f.IN_NODE || ($ = (await import("./browser-external_node_url-CNJF6H2t.js").then((m) => /* @__PURE__ */ __toESM(m.default, 1))).default, B = await import("./browser-external_node_fs-edSPA3ra.js").then((m) => /* @__PURE__ */ __toESM(m.default, 1)), L = await import("./promises-BLBYDbiM.js").then((m) => /* @__PURE__ */ __toESM(m.default, 1)), (await import("./browser-external_node_vm-DQ0-VG3V.js").then((m) => /* @__PURE__ */ __toESM(m.default, 1))).default, x = await import("./browser-external_node_path-CWzxSPva.js").then((m) => /* @__PURE__ */ __toESM(m.default, 1)), T = x.sep, typeof R < "u")) return;
	let s = {
		fs: B,
		crypto: await import("./browser-external_node_crypto-BWoI_bRt.js").then((m) => /* @__PURE__ */ __toESM(m.default, 1)),
		ws: await import("./browser-external_ws-Cppa_2Hg.js").then((m) => /* @__PURE__ */ __toESM(m.default, 1)),
		child_process: await import("./browser-external_node_child_process-BP1hy-SF.js").then((m) => /* @__PURE__ */ __toESM(m.default, 1))
	};
...
async function J() {
	...
	if (f.IN_NODE && !t.startsWith("file://") && (t = `file://${t}`), f.IN_NODE_ESM) {
		let i = await import("./browser-external_node_path-CWzxSPva.js").then((m) => /* @__PURE__ */ __toESM(m.default, 1));
		return (await import("./browser-external_node_url-CNJF6H2t.js").then((m) => /* @__PURE__ */ __toESM(m.default, 1))).fileURLToPath(i.dirname(t));
	}
...
async function Se(e = {}) {
	...
	if (t = k(w(t)), e.packageBaseUrl = k(e.packageBaseUrl), e.cdnUrl = k(e.packageBaseUrl ?? `https://cdn.jsdelivr.net/pyodide/v314.0.2/full/`), !e.lockFileContents) {
	...
	let n = {
		...
		checkAPIVersion: !0,
		BUILD_ID: "a4189f0fe3d610ecd603639c08596362b70a34b106c58c9a93486c22df4c89a5"
	}, i = Object.assign(n, e);
...
function Fe(e, t) {
	let n = e.API;
	if (t.pyproxyToStringRepr && n.setPyProxyToStringMethod(!0), t.convertNullToNone && n.setCompatNullToNone(!0), t.toJsLiteralMap && n.setCompatToJsLiteralMap(!0), n.version !== "314.0.2" && t.checkAPIVersion) throw new Error(`Pyodide version does not match: '${U}' <==> '${n.version}'. If you updated the Pyodide version, make sure you also updated the 'indexURL' parameter passed to loadPyodide.`);
	e.locateFile = (i) => {
