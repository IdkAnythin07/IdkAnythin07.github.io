//#region node_modules/monaco-editor/esm/vs/basic-languages/systemverilog/systemverilog.js
/*!-----------------------------------------------------------------------------
...
var conf = {
	...
	folding: {
		offSide: false,
		markers: {
			start: /* @__PURE__ */ new RegExp("^(?:\\s*|.*(?!\\/[\\/\\*])[^\\w])(?:begin|case(x|z)?|class|clocking|config|covergroup|function|generate|interface|module|package|primitive|property|program|sequence|specify|table|task)\\b"),
			end: /* @__PURE__ */ new RegExp("^(?:\\s*|.*(?!\\/[\\/\\*])[^\\w])(?:end|endcase|endclass|endclocking|endconfig|endgroup|endfunction|endgenerate|endinterface|endmodule|endpackage|endprimitive|endproperty|endprogram|endsequence|endspecify|endtable|endtask)\\b")
		}
	}
};
var language = {
	...
	tokenizer: {
		...
		identifier_or_keyword: [[/@identifier/, { cases: {
