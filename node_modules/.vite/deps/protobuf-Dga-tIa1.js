//#region node_modules/monaco-editor/esm/vs/basic-languages/protobuf/protobuf.js
/*!-----------------------------------------------------------------------------
...
var conf = {
	...
	autoCloseBefore: ".,=}])>' \n	",
	indentationRules: {
		increaseIndentPattern: /* @__PURE__ */ new RegExp("^((?!\\/\\/).)*(\\{[^}\"'`]*|\\([^)\"'`]*|\\[[^\\]\"'`]*)$"),
		decreaseIndentPattern: /* @__PURE__ */ new RegExp("^((?!.*?\\/\\*).*\\*/)?\\s*[\\}\\]].*$")
	}
};
var language = {
	defaultToken: "",
