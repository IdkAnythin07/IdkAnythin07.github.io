//#region node_modules/monaco-editor/esm/vs/basic-languages/ruby/ruby.js
/*!-----------------------------------------------------------------------------
...
var conf = {
	...
	indentationRules: {
		...
		decreaseIndentPattern: /* @__PURE__ */ new RegExp("^\\s*([}\\]]([,)]?\\s*(#|$)|\\.[a-zA-Z_]\\w*\\b)|(end|rescue|ensure|else|elsif|when)\\b)")
	}
};
var language = {
	tokenPostfix: ".ruby",
