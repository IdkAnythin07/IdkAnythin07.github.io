//#region node_modules/monaco-editor/esm/vs/basic-languages/postiats/postiats.js
/*!-----------------------------------------------------------------------------
...
var language = {
	...
	tokenizer: {
		root: [
			...
			{
				regex: /,/,
				action: { token: "delimiter.comma" }
			},
			{
				regex: /;/,
				action: { token: "delimiter.semicolon" }
			},
			{
				regex: /@\(/,
				action: "@brackets"
			...
			{
				regex: /%\(/,
				action: { token: "delimiter.parenthesis" }
			},
			{
				regex: /^%{(#|\^|\$)?/,
				action: {
			...
			{
				regex: /'\[/,
				action: { token: "delimiter.bracket" }
			},
			{
				regex: /'\{/,
				action: { token: "delimiter.brace" }
			},
