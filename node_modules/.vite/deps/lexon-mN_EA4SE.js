//#region node_modules/monaco-editor/esm/vs/basic-languages/lexon/lexon.js
/*!-----------------------------------------------------------------------------
...
var conf = {
	...
	folding: { markers: {
		start: /* @__PURE__ */ new RegExp("^\\s*(::\\s*|COMMENT\\s+)#region"),
		end: /* @__PURE__ */ new RegExp("^\\s*(::\\s*|COMMENT\\s+)#endregion")
	} }
};
var language = {
	tokenPostfix: ".lexon",
